		...
		<form action="<?php $this->text('wgScript'); ?>" id="searchform" class="form-inline">
			...
			<div class="input-group">
				...
				<span class="input-group-btn">
					...
					// @codingStandardsIgnoreStart 
					?>
					<button type="submit" title="Go straight to page" name="go" value="<?php echo $skin->msg('go')->plain() ?>" id="searchGoButton" class="btn btn-secondary" type="button"><span class="fa fa-eye"></span></button>
					<button type="submit" title="Search for page" name="fulltext" value="<?php echo $skin->msg('searchbutton')->plain() ?>" id="mw-searchButton" class="btn btn-secondary" type="button">
		...
		<div class="navbar-login">
			...
			?>
				<div class="dropdown login-menu">
					<a class="dropdown-toggle" style="display: flex; align-items: center;" type="button" id="login-menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<?php echo $avatar; ?>
					</a>
					<div class="dropdown-menu dropdown-menu-right login-dropdown-menu" aria-labelledby="login-menu">
						...
						<a href="<?php echo $personalTools['logout']['links'][0]['href']; ?>" class="dropdown-item view-logout" title="<?php echo Linker::titleAttrib('pt-logout', 'withaccess'); ?>">
							<?php echo $skin->msg('logout')->plain(); ?></a>
					</div>
				</div>
			<?php } else { ?>
				<a href="#" title="Log In" class="none-outline" data-toggle="modal" data-target="#login-modal">
